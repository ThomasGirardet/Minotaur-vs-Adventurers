...
[CustomEditor(typeof(MinotaurFieldOfView))]
public class FieldOfViewEditor: Editor
{
    private void OnSceneGUI()
    {
        MinotaurFieldOfView fov = (MinotaurFieldOfView)target;
        ...
        if(fov.canSeeAdventurer)
        {
            Handles.color = Color.green;
            Handles.DrawLine(fov.transform.position, fov.adventurerRefList[fov.adventurerSeen].transform.position);
        }
    }
